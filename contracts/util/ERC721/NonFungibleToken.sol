...
contract NonFungibleToken is INonFungibleToken, ERC721, Ownable {
    ...
    function mint(address recipient, string memory tokenURI) external override onlyOwner returns (uint256) {
        _tokenIds.increment();
